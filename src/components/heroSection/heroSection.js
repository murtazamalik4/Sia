  ...
  return (
    <div style={{ minHeight: "100vh" }}>
      <link
        ...
        rel="stylesheet"
        id="e-animations-css"
        href="/customcss/e-animations.min.css"
        type="text/css"
        media="all"
      />
      <link
        ...
        <rs-module id="rev_slider_1_1" style={{}} data-version="6.5.25">
          <rs-slides>
            <rs-slide
              ...
              data-key="rs-1"
              data-title="Slide"
              data-thumb="//images/slider1-1.jpg"
            ...
            >
              <img
                ...
                data-lazyload="/images/slider1-1.jpg"
            ...
            <rs-slide
              ...
              data-key="rs-8"
              data-title="Slide"
              data-thumb="/images/slider2-1.jpg"
              data-anim="ms:1000;r:0;"
              data-in="o:0;"
              data-out="a:false;"
            >
              <img
                src="/images/slider2-1.jpg"
                alt=""
                title="about-slider-2-copyright"
                width={1920}
                height={870}
                className="rev-slidebg tp-rs-img rs-lazyload"
                data-lazyload="/images/slider2-1.jpg"
                data-panzoom="d:10000;ss:100;se:106%;"
                data-no-retina
              />
              <rs-layer
                ...
                data-color="#ffc94a"
                data-xy="x:c;y:m;yo:6px,6px,3px,-19px;"
                data-text="w:normal;s:75,85,46,22;l:105,105,57,35;fw:900;a:center;"
                data-frame_0="rX:70deg;oZ:-50;"
                data-frame_0_chars="d:5;y:cyc(-100||100);o:0;"
                data-frame_1="oZ:-50;sp:700;"
                data-frame_1_chars="e:power2.out;dir:middletoedge;d:5;"
              ...
              >
                <span>A place for our community</span>
                <br />
            ...
            <rs-slide
              ...
              data-key="rs-9"
              data-title="Slide"
              data-thumb="/images/slider3-1.jpg"
              data-anim="ms:1000;r:0;"
              data-in="o:0;"
              data-out="a:false;"
            >
              <img
                src="/images/slider3-1.jpg"
                alt=""
                title="about-slider-3-copyright"
                width={1920}
                height={870}
                className="rev-slidebg tp-rs-img rs-lazyload"
                data-lazyload="/images/slider3-1.jpg"
                data-panzoom="d:10000;ss:100;se:106%;"
                data-no-retina
              />
              <rs-layer
              ...
              >
                ...
                <br />
                <span> history and build a legacy for the future</span>
              </rs-layer>
              <a
