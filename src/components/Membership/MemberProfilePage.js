    ...
    <div className="memberprofilepage">
        <div className="profilepagemain">
            <div className="userinfo">
                ...
                <div className="fname"><span>Full Name:</span> <span>John Smith</span></div>
                <div className="mobile"><span>Mobile:</span> <span>(44) 123 1234 123</span></div>
                <div className="email"><span>Email:</span> <span>johnsmith@gmail.com</span></div>
                <div className="location"><span>Location:</span> <span>Singapore</span></div>
            </div>
                    ...
                    <div className="package">
                        <div className="package1">
                            <div className="left">
                                ...
                                <div className="membership"><span>Membership:</span> &nbsp; &nbsp; &nbsp; <span>Renewal</span></div>
                                <div className="eaddress"><span>Email Address:</span> &nbsp; &nbsp; <span>oliver@burrito.com</span></div>
                                <div className="memid"><span>Membership ID:</span> &nbsp; <span>#1234566</span></div>
                                <div className="amount"><span>Amount:</span> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<span>SGD 100.00</span></div>
                            </div>
                            <div className="right">
                                ...
                                <div className="paynow"><button>Pay Now</button></div>
                                <div className="remdays"><span style={{color: "#FF1A1A"}}>*</span> 10 days left</div>
                            </div>
                        </div>
